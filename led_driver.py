...
from constants import LED_START, RGB_MAP
...
class APA102:
    ...
    def __init__(self, num_led=8, order='rgb', global_brightness=4, SPI_BUS=1, SPI_DEVICE=0, SPI_SPEED_HZ=500000 * 3):
        ...
        self.leds = [LED_START, 0, 0, 0] * self.num_led  # Pixel buffer
